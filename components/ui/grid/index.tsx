...
type IGridProps = ComponentPropsWithRef<typeof View> &
...
type IGridItemProps = ComponentPropsWithRef<typeof View> &
...
const GridItem = function GridItem({
  ...
  const [flexBasisValue, setFlexBasisValue] = useState<number | string | null>(
    "auto",
  );
